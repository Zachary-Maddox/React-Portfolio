        ...
        <div>
            ...
            <div className="GamegetterContainer  flex flex-1 flex-row mb-8">
                ...
                <div className=" flex justify-center">
                    <i  > <SiHandlebarsdotjs size={30}/></i>
                    <i className="ml-2" > <SiJavascript size={30} color="yellow"/></i>
                    <i className="ml-2"> <IoLogoCss3  size={30} color="blue"/></i>
                    <i className="ml-2">  <FaNodeJs  size={30} color="green"/></i>
                    <i className="ml-2">  < FaHtml5 size={30} color="red"/></i>
                    <i className="ml-2"> <SiMysql  size={30} color="orange" /></i>
                </div>
                </div>
            </div>
